...
parser.add_argument("--part", type=int, help="指定验证分片编号 0~15")
...
def clean_rule(line):
    l = line.strip()
    if not l or l.startswith("#") or l.startswith("!") or l.startswith("||browser.events.data.msn.cn"):
        return None
    return l
